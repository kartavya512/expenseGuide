  ...
  return (
    <div className="">
      ...
      <div className="flex justify-center h-screen w-full">
        <div className="flex flex-col lg:pt-36 pt-60 lg:w-[20%] w-[75%]">
          <div className="text-white font-bold text-3xl lg:pl-24 pl-[6rem] lg:p-5">
            Signup
          </div>
          <div className="pt-10 flex flex-col justify-between">
            ...
            <button className="bg-green-400 p-2 rounded-md">Signup</button>
            <div className="pt-5">
