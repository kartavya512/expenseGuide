  ...
  return (
    <div className="fixed">
      ...
      <div className="">
        ...
        <div className="flex  lg:flex-row justify-evenly flex-col-reverse h-[80vh] p-5 lg:p-40 pt-2 lg:pt-40">
          <div className="lg:w-1/2">
            ...
            <div className="lg:pt-5 pt-5">
              Track your expenses effortlessly and gain financial clarity with
              our intuitive expense tracker. Stay on top of your spending, save
              ...
              <ul className="lg:pl-5 text-white">
                <li className="flex">
                  <div className="before:content-['•'] before:text-green-400 before:mr-2 flex items-baseline">
                    ...
                    <div className="lg:pl-3">
                      Easy-to-use interface for seamless expense tracking.
                    </div>
                  </div>
                </li>
                ...
                <li className="flex pt-5">
                  <div className="before:content-['•'] before:text-green-400 before:mr-2 flex items-baseline">
                    ...
                    <div className="pl-3">
                      Your financial data is safe and secure with us.
                    </div>
                  </div>
                </li>
              </ul>
            ...
            <div className="pt-10">
              <Link href="/signup">
                <button className="bg-green-400 p-2 text-gray-50 rounded-md">
                  Start Tracking Now
                </button>
              </Link>
            </div>
